...
class GuidedOnboardingPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GuidedOnboardingPage> createState() =>
      _GuidedOnboardingPageState();
}
...
class _GuidedOnboardingPageState extends ConsumerState<GuidedOnboardingPage> {
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Confirma la base de tu empresa antes de comenzar a operar.',
          ),
          const SizedBox(height: 20),
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            step == null ? 'Configuración completa' : _title(step),
          ...
          Align(
            ...
            child: FilledButton.icon(
              ...
              label: Text(
                step == GuidedOnboardingStep.review
  ...
  Widget _verificationBox(ThemeData theme, GuidedOnboardingStep? step) =>
      Container(
  ...
  String _description(GuidedOnboardingStep? step) => switch (step) {
    GuidedOnboardingStep.businessProfile =>
      'StOmni verificará que tu empresa tenga una configuración empresarial creada antes de continuar.',
    GuidedOnboardingStep.modules =>
      'Confirma la configuración base de módulos. Podrás ajustar capacidades posteriormente desde la administración del negocio.',
    GuidedOnboardingStep.operations =>
      'Verifica que exista una sucursal principal y una caja predeterminada activas para comenzar a operar.',
    GuidedOnboardingStep.review =>
      'Revisa que los pasos anteriores estén completos. Al finalizar entrarás al espacio de trabajo de tu empresa.',
    null => 'Tu empresa ya está lista para usar StOmni.',
  };

  String _verification(GuidedOnboardingStep? step) => switch (step) {
    GuidedOnboardingStep.businessProfile =>
      'El servidor valida la existencia de configuracion_negocio para tu organización.',
    GuidedOnboardingStep.modules =>
      'El servidor valida business_capabilities del tenant; esta pantalla no inventa ni duplica esa configuración.',
    GuidedOnboardingStep.operations =>
      'El servidor exige sucursal principal activa y caja predeterminada activa.',
    GuidedOnboardingStep.review =>
      'El servidor sólo permite cerrar el onboarding si los tres pasos anteriores ya fueron reconocidos en orden.',
