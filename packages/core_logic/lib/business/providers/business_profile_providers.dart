...
final businessProfileGatewayProvider = Provider<BusinessProfileGateway>((ref) =>
    SupabaseBusinessProfileGateway(ref.watch(supabaseProvider),
      cacheNamespace: const String.fromEnvironment('SUPABASE_URL')));

final businessSalePolicyProvider = Provider<BusinessSalePolicy>((ref) =>
    ConfiguredBusinessSalePolicy(ref.watch(businessProfileGatewayProvider)));

final updateBusinessCapabilitiesUseCaseProvider = Provider<UpdateBusinessCapabilitiesUseCase>((ref) =>
    UpdateBusinessCapabilitiesUseCase(gateway: ref.watch(businessProfileGatewayProvider),
