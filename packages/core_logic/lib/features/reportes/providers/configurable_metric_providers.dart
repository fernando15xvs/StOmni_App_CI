...
final configurableMetricGatewayProvider = Provider<ConfigurableMetricGateway>(
  (ref) => SupabaseConfigurableMetricGateway(ref.watch(supabaseProvider)),
);

final configurableMetricsUseCaseProvider = Provider<ConfigurableMetricsUseCase>(
  (ref) => ConfigurableMetricsUseCase(
