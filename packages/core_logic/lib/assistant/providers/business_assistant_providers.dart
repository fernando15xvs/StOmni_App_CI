...
final businessAssistantGatewayProvider = Provider<BusinessAssistantGateway>(
  (ref) => SupabaseBusinessAssistantGateway(ref.watch(supabaseProvider)),
);

final businessAssistantUseCaseProvider = Provider<BusinessAssistantUseCase>(
  (ref) => BusinessAssistantUseCase(
