...
void main() {
  group('PriceVisualUtils - getPrecioVisual', () {
    test(
      '1. cajas completas: 2C, PCS 10, precio base S/ 2.00, total S/ 40.00 -> mostrar S/ 20.00',
      () {
    ...
    test(
      '2. venta mixta: 1C 2U, PCS 10, precio base S/ 4.00, total S/ 48.00 -> mostrar S/ 4.00',
      () {
        final precio = PriceVisualUtils.getPrecioVisual(
    ...
    test(
      '3. SOLO_CAJAS, 3 cajas, PCS 40, precio base S/ 4.00, total S/ 480.00 -> mostrar S/ 160.00',
      () {
        final precio = PriceVisualUtils.getPrecioVisual(
          precioUnitarioBase: 4.00,
          pcs: 40,
    ...
    test(
      '5. PCS cero o negativo usa fallback seguro a 1 y asume cajas cerradas si divide exacto',
      () {
        final precio = PriceVisualUtils.getPrecioVisual(
    ...
    test(
      '8. Cantidad cero: caso extremo asume mixto o cero cajas enteras según la regla',
      () {
        final precio = PriceVisualUtils.getPrecioVisual(
          precioUnitarioBase: 2.00,
          pcs: 10,
