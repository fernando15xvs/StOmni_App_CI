...
void main() {
  test('el modelo comercial genérico no depende del contrato legacy ni de UI', () {
    final source = _read(
    ...
    for (final forbidden in <String>[
      ...
      expect(
        ...
        reason: 'El modelo comercial genérico volvió a depender de $forbidden',
      );
    }
  ...
  test('StockUtils funciona como adaptador del esquema comercial histórico', () {
  ...
  test('el catálogo tipado expone el perfil comercial a cualquier interfaz', () {
    final source = _read(
