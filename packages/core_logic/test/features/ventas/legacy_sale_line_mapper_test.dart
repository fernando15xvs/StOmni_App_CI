...
void main() {
  group('LegacySaleLineMapper', () {
    test('prepara una venta por caja con equivalencia de unidades', () {
      ...
      final prepared = LegacySaleLineMapper.map(line);
    ...
    test('rechaza cantidad fraccionaria mientras el inventario sea legacy', () {
      final line = SaleCartMapper.decodeLine({
        'id': 20,
        'cantidad': 1.5,
        'subtotal': 15.0,
