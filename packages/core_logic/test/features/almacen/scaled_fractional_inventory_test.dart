...
void main() {
  ...
  test('configured sale line preserves visible, base and stored quantities', () {
    final configuration = kilograms();
  ...
  test('profile rejects commercial precision that cannot map to base scale', () {
    expect(
  ...
  test('legacy integer profiles keep scale one', () {
    ...
    final configuration = ProductUnitConfiguration(revision: 1, profile: profile);
