...
void main() {
  test('FixedQuantity conserva precisión decimal sin comparar doubles libres', () {
  ...
  test('perfil decimal valida kg y saco sin introducir enums por sector', () {
    ...
    expect(() => IntegerPresentationPolicy.validate(profile), throwsArgumentError);
  });

  test('configuración convierte cantidad visible a unidades menores y vuelve', () {
    final kg = CommercialPresentation.base(
      code: 'kg',
      singularLabel: 'kg',
      pluralLabel: 'kg',
