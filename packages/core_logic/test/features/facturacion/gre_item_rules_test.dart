...
void main() {
  group('GreItemRules', () {
    test('usa PK como unidad base para paquetes y caja+paquetes', () {
      expect(
        GreItemRules.unidadBaseProducto({'tipo_venta': 'PAQUETES'}),
        'PK',
      );
      expect(
    ...
    test('caja+paquetes permite BX y PK', () {
      ...
      expect(
        GreItemRules.unidadesPermitidas(producto, 'PK'),
        ['BX', 'PK'],
      );
    });
    ...
    test('caja+unidades permite BX y NIU', () {
      ...
      expect(
        GreItemRules.unidadesPermitidas(producto, 'NIU'),
        ['BX', 'NIU'],
      );
    });
    ...
    test('conserva una unidad histórica actualmente seleccionada', () {
      ...
      expect(
        GreItemRules.unidadesPermitidas(producto, 'ZZ'),
        ['BX', 'NIU', 'ZZ'],
      );
    });
